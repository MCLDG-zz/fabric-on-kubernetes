...
--parameter-overrides VPCId=vpc-21fb5749 CidrBlock=172.20.0.0/24 RouteTableID=rtb-f7ec759f KeyName=dlt-blockchain-key VolumeName=dltefs MountPoint=efsmount \
